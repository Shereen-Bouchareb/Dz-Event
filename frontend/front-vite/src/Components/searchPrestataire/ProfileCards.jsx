...
export default function ProfileCards({id , role , bio , profilePic , wilaya , firstName, famillyName , rating}) {
  return (
    <div>
    <Link to={`/DetailedProfile/${id}`}>
      <div style={{display:"block" , width:"279px" , height:"470px" , backgroundColor:"#F0E5CF" , borderRadius:"10px" , cursor:"pointer" }}>
        ...
        <div style={{display:"flex"}}>
            <p style={{color:"#75574A" , fontSize:"18px"}}><b>{firstName}</b></p>
            <p style={{color:"#75574A" , fontSize:"18px", marginLeft:"4px"}}><b>{famillyName}</b></p>
            <div style={{display:"flex" , width:"130px" , paddingLeft:"70px"}}>
