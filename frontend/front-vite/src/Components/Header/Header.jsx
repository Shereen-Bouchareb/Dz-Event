...
function Header() {
  return (
    <div style={{width:"100%"}}>
      <div className='firstHeader' style={{height:"42px" , width:"100%" ,  backgroundColor:"#D08E70" , textAlign:"center" , display:"flex" ,justifyContent:"center" , alignItems:"center"}}>
      ...
      <div className='secondHeader' style={{height:"65px" , width:"100%" , backgroundColor:"#F0E5CF" , display:"flex"}}>
        <div className='logo'>
